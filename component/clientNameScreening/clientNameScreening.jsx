...
const ClientNameScreening = ({ setDataSubmitted, results, setResults }) => {
    ...
    const autoMatchColumns = (headers) => {
        ...
        headers.forEach(header => {
            ...
            } else if (normalizedHeader.includes('Identity Number') || normalizedHeader.includes('Identity Number')) {
                newMapping.name3 = newMapping.name3 || header;
            } else if (normalizedHeader.includes('D.O.B Start') || normalizedHeader.includes('D.O.B Satrt')) {
...
export default ClientNameScreening;