...
import styles from './entityNameScreening.module.css';

const EntityNameScreening = ({ setDataSubmitted }) => {
    ...
    const autoMatchColumns = (headers) => {
        ...
        headers.forEach(header => {
            ...
            // Try partial match
            if (normalizedHeader.includes('Business Registration Number') || normalizedHeader.includes('Business Registration Number')) {
                newMapping.name1 = newMapping.name1 || header;
            } else if (normalizedHeader.includes('Business Name') || normalizedHeader.includes('Business Name')) {
...
export default EntityNameScreening;