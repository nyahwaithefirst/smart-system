            ...
            <div className="row gx-0">
                <div className="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                    <div className="d-inline-flex align-items-center" style={{height: "45px"}}>
                        <small className="me-3 text-light"><i className="fa fa-map-marker-alt me-2"></i>123 Street, Harare, Zimbabwe</small>
                        <small className="me-3 text-light"><i className="fa fa-phone-alt me-2"></i>+263 776 980 472</small>
                        <small className="text-light"><i className="fa fa-envelope-open me-2"></i>info@techsys@.co.zw</small>
                    </div>
                </div>
