...
import RiskProfilingComponent from "../../../../../component/riskProfiling/riskProfiling/riskProfiling";
    ...
    return (
        <div className={styles.container}>
                ...
                <div className={styles.itemsWrapper}>
                    <div>
                        ...
                        <ul className={styles.items}>
                            <li
                                className={`${styles.item} ${itemIndex === 1 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 2 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 3 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 4 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 5 && styles.itemActive
                                    }`}
                    ...
                    <div>
                        ...
                        <ul className={styles.items}>
                            <li
                                className={`${styles.item} ${itemIndex === 6 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 7 && styles.itemActive
                                    }`}
                            ...
                            <li
                                className={`${styles.item} ${itemIndex === 8 && styles.itemActive
                                    }`}
            ...
            <div className={styles.mainContent}>
                ...
                {itemIndex === 2 && <RiskProfilingComponent />}
